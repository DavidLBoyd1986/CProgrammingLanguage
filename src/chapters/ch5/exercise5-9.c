...
static char daytab_normal[13] = {0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
static char daytab_leap[13] = {0, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
static char *daytab[] = { daytab_normal, daytab_leap };
...
printf("\n Testing Error Handling for day_of_year:\n");
...
printf("\n Testing Error Handling for month_day:\n");
